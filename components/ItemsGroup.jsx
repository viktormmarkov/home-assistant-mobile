...
function renderItem(config, { item, section, index }) {
  ...
  const touchableStlyes = _.compact([
    styles.squareContainer,
    isSelected ? styles[selectedClass] : null,
  ]);
  return (
    <TouchableOpacity
      style={touchableStlyes}
      onPress={() => config.tilePress(item, section, index)}
    >
      <View key={item._id}>
